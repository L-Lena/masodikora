...
SZULEV numeric(4) MASKED WITH (FUNCTION = 'random(1900,2025)'),
NEM varchar(1) MASKED WITH (FUNCTION='default()'),
CIM varchar(128) MASKED WITH (FUNCTION = 'partial(2,"XXX",2)')
)
...
CREATE USER webshopuser WITHOUT LOGIN;
GRANT SELECT ON UGYFEL TO webshopuser

EXECUTE AS User= 'webshopuser';
SELECT * FROM UGYFEL
REVERT
